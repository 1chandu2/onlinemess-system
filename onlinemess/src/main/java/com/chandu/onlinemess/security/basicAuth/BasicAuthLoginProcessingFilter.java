...
import com.chandu.onlinemess.dto.LoginRequest;
import com.chandu.onlinemess.common.exception.RequestMethodNotSupportedException;
...
public class BasicAuthLoginProcessingFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!HttpMethod.POST.name().equals(request.getMethod())) {
            ...
            throw new RequestMethodNotSupportedException("Authentication method not supported");
        }
